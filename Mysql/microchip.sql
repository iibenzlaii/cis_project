...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 18, 2019 at 08:47 PM
...
INSERT INTO `abouts` (`id`, `about_title`, `about_subtitle`, `about_content`, `about_image`, `created_at`, `updated_at`) VALUES
(1, 'Chickdog', 'จำหน่ายปอมเมอเรเนียนแท้', 'จำหน่ายปอมเมอเรเนียนแท้ สายพันธ์ุดี แข็งแรงพร้อมรับประกันสุขภาพน้องหมา ยินดีให้คำปรึกษาตลอดการเลี้ยงดู มีบริการส่งฟรีทั่วประเทศ ยินดีรับบัตรเครดิต', 'about.jpg', '2019-07-13 13:56:08', '2019-07-13 13:56:08');
...
CREATE TABLE `articles` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `article_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `contacts` (
  ...
  `contact_tel_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_map` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_facebook` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_facebook_link` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `contact_line_qr` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `contacts` (`id`, `contact_name`, `contact_address`, `contact_tel_no`, `contact_map`, `contact_facebook`, `contact_facebook_link`, `contact_line_qr`, `created_at`, `updated_at`) VALUES
(1, 'CHICK DOG Farm', 'กาญจน์กนก 21 Muang Chiang Mai, Chiang Mai, Thailand', '0910720197', 'https://www.google.com/maps/embed/v1/place?key=AIzaSyAlnf6iTIs_i_Ua04uLY7xBZOLDQtIlNc0&q=18.7481487366,98.9570212281&zoom=15', 'CHICK DOG Farm', 'https://www.facebook.com/chickDogCM/?__tn__=%2CdK-R-R&eid=ARBUSuU_47bxO1mswycSh0jlM2sL_U_eWH_UxZjuRJLFGA3dcC8uhQzXPBoSHJ3KT02ki9Ox6vtQYClK&fref=mentions', 'qr.png', '2019-07-13 13:56:08', '2019-07-13 13:56:08');
...
CREATE TABLE `dogs` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `dog_breed` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_color` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_sex` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_birth_date` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_farm_name` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_buy_price` decimal(8,0) NOT NULL,
  `dog_sell_price` decimal(8,0) NOT NULL,
  `dog_image` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dog_owner` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dog_status` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_status` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `microchip_id` char(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `dogs` (`id`, `dog_breed`, `dog_color`, `dog_sex`, `dog_birth_date`, `dog_farm_name`, `dog_buy_price`, `dog_sell_price`, `dog_image`, `dog_owner`, `dog_status`, `install_status`, `microchip_id`, `created_at`, `updated_at`) VALUES
(1, 'ปอมเมอเรเนียน', 'สีดำ', 'ตัวเมีย', '2019-04-12', 'TinyDog', '5000', '7500', 'pom_black1.jpg', 'Customer 1', '3', '0', NULL, '2019-07-13 13:56:08', '2019-07-13 14:08:36'),
(2, 'ปอมเมอเรเนียน', 'สีขาว', 'ตัวเมีย', '2019-01-20', 'TinyDog', '4500', '7000', 'pom_white1.jpg', 'test', '3', '0', NULL, '2019-07-13 13:56:08', '2019-07-14 01:22:43'),
(3, 'ปอมเมอเรเนียน', 'สีน้ำตาลอ่อน', 'ตัวเมีย', '2019-06-18', 'ChickDog', '5000', '7500', 'pom_brownwhite1.jpg', NULL, '0', '0', NULL, '2019-07-13 13:56:08', '2019-07-13 13:56:08'),
(4, 'ปอมเมอเรเนียน', 'สีน้ำตาล', 'ตัวผู้', '2019-05-10', 'ChickDog', '5500', '8000', 'pom_brown1.jpg', NULL, '0', '0', NULL, '2019-07-13 13:56:08', '2019-07-13 13:56:08'),
(5, 'ปอมเมอเรเนียน', 'สีขาว', 'ตัวผู้', '2019-06-18', 'TinyDog', '5500', '8000', 'pom_white2.jpg', 'ชาณิศา แก้วมะคำ', '3', '1', '3', '2019-07-13 13:56:08', '2019-07-15 04:14:59'),
(6, 'ปอมเมอเรเนียน', 'สีน้ำตาล', 'ตัวผู้', '2019-06-20', 'ChickDog', '5700', '8500', 'pom_brown2.jpg', NULL, '0', '0', NULL, '2019-07-13 13:56:08', '2019-07-13 13:56:08'),
(7, 'ปอมเมอเรเนียน', 'สีดำอ่อน', 'ตัวเมีย', '2019-06-20', 'CutePet', '6000', '9000', 'pom_blackwhite1.jpg', NULL, '1', '0', NULL, '2019-07-13 13:56:08', '2019-07-13 14:05:43'),
(8, 'ปอมเมอเรเนียน', 'สีขาวลายน้ำตาล', 'ตัวเมีย', '2019-06-20', 'TinyDog', '6000', '9000', 'pom_brownwhite3.jpg', 'Customer 2', '3', '1', '2', '2019-07-13 13:56:08', '2019-07-13 14:08:26'),
(9, 'ปอมเมอเรเนียน', 'สีน้ำตาล', 'ตัวเมีย', '2019-06-30', 'CutePet', '5000', '7000', 'pom_brown2.jpg', NULL, '0', '0', NULL, '2019-07-13 13:56:08', '2019-07-13 13:56:08'),
(10, 'ปอมเมอเรเนียน', 'สีขาวลายน้ำตาล', 'ตัวผู้', '2019-04-10', 'ChickDog', '6000', '8900', 'pom_brownwhite4.jpg', NULL, '0', '0', NULL, '2019-07-13 13:56:08', '2019-07-13 13:56:08');
...
CREATE TABLE `dog_breeds` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `dog_breed` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_breed_male_count` int(11) NOT NULL,
  `dog_breed_female_count` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `dog_breeds` (`id`, `dog_breed`, `dog_breed_male_count`, `dog_breed_female_count`, `created_at`, `updated_at`) VALUES
(1, 'ปอมเมอเรเนียน', 4, 6, '2019-07-13 13:56:08', '2019-07-13 13:56:08');

-- --------------------------------------------------------

--
-- Table structure for table `dog_farms`
--

CREATE TABLE `dog_farms` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `dog_farm_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_farm_count` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `dog_farms`
--

INSERT INTO `dog_farms` (`id`, `dog_farm_name`, `dog_farm_count`, `created_at`, `updated_at`) VALUES
(1, 'ChickDog', 4, '2019-07-13 13:56:08', '2019-07-13 13:56:08'),
(2, 'TinyDog', 4, '2019-07-13 13:56:08', '2019-07-13 13:56:08'),
(3, 'CutePet', 2, '2019-07-13 13:56:08', '2019-07-13 13:56:08');
...
CREATE TABLE `homes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `home_welcome_text` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `home_background_image` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `homes` (`id`, `home_welcome_text`, `home_background_image`, `created_at`, `updated_at`) VALUES
(1, 'Welcome to CHICKDOG', '1563092958.jpg', '2019-07-13 13:56:08', '2019-07-14 01:29:18');

-- --------------------------------------------------------

--
-- Table structure for table `install_microchips`
--

CREATE TABLE `install_microchips` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `install_microchip_breed` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_color` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_sex` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_birth_date` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `install_microchip_image` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `install_microchip_owner_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_owner_tel_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_owner_house_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_owner_village_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_owner_lane` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_owner_road` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_owner_province` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_owner_amphures` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_owner_districts` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `install_microchip_owner_post_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_booking_date` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `install_microchip_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_status` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `microchip_id` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_id` char(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `install_microchips`
--

INSERT INTO `install_microchips` (`id`, `install_microchip_breed`, `install_microchip_color`, `install_microchip_sex`, `install_microchip_birth_date`, `install_microchip_image`, `install_microchip_owner_name`, `install_microchip_owner_tel_no`, `install_microchip_owner_house_no`, `install_microchip_owner_village_no`, `install_microchip_owner_lane`, `install_microchip_owner_road`, `install_microchip_owner_province`, `install_microchip_owner_amphures`, `install_microchip_owner_districts`, `install_microchip_owner_post_no`, `install_microchip_booking_date`, `install_microchip_no`, `install_microchip_status`, `microchip_id`, `dog_id`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 'ปอมเมอเรเนียน', 'สีขาวลายน้ำตาล', 'ตัวเมีย', '2019-06-20', 'pom_brownwhite3.jpg', 'Customer 2', '0653262225', '5/2', '-', '2', 'road2', 'เพชรบุรี', 'ชะอำ', 'นายาง', '12345', NULL, '5U5QZP5B8PO3E', '1', '2', '8', NULL, '2019-07-13 14:04:25', '2019-07-13 14:04:25'),
(2, 'ปอมเมอเรเนียน', 'สีขาว', 'ตัวผู้', '2019-06-18', 'pom_white2.jpg', 'ชาณิศา แก้วมะคำ', '0849191500', '62/1', '13', '1', '-', 'ลำพูน', 'แม่ทา', 'ทาสบเส้า', '51140', NULL, '96AGXC8OJ9LYW', '1', '3', '5', '0', '2019-07-13 14:21:04', '2019-07-15 04:16:44'),
(3, 'ชิวาว่า', 'ดำ', 'ตัวเมีย', NULL, NULL, 'Customer 4', '1111111111', 'Customer 4', '1111111111', '1', 'road 4', 'นครนายก', 'ปากพลี', 'ปากพลี', '55555', '2019-07-25', '658HI4DH1ZLRU', '1', '1', NULL, NULL, '2019-07-13 14:26:53', '2019-07-13 14:27:20'),
(4, 'ปอม', 'ขาว', 'ตัวเมีย', NULL, '1563190615.jpg', 'ชาณิศา แก้วมะคำ', '0849191500', 'ชาณิศา แก้วมะคำ', '13', '62/1', 'แม่ทา-ท่าจักร', 'ลำพูน', 'แม่ทา', 'ทาสบเส้า', '51140', '2019-07-16', 'K9FV1YEP0VVJG', '1', '4', NULL, NULL, '2019-07-15 04:36:55', '2019-07-15 04:41:28');

-- --------------------------------------------------------

--
-- Table structure for table `microchips`
--

CREATE TABLE `microchips` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `microchip_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `microchip_buy_price` decimal(8,0) NOT NULL,
  `microchip_sell_price` decimal(8,0) NOT NULL,
  `microchip_owner` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `microchip_status` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_status` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_id` char(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `microchips`
--

INSERT INTO `microchips` (`id`, `microchip_no`, `microchip_buy_price`, `microchip_sell_price`, `microchip_owner`, `microchip_status`, `install_status`, `dog_id`, `created_at`, `updated_at`) VALUES
(1, '658HI4DH1ZLRU', '500', '1000', 'Customer 3', '3', '1', NULL, '2019-07-13 13:56:08', '2019-07-13 14:27:20'),
(2, '5U5QZP5B8PO3E', '400', '800', 'Customer 2', '3', '1', '8', '2019-07-13 13:56:08', '2019-07-13 14:08:26'),
(3, '96AGXC8OJ9LYW', '300', '600', 'ชาณิศา แก้วมะคำ', '3', '1', '5', '2019-07-13 13:56:08', '2019-07-15 04:14:59'),
(4, 'K9FV1YEP0VVJG', '400', '800', 'นิศา แก้วมะคำ', '3', '1', NULL, '2019-07-13 13:56:08', '2019-07-15 04:41:28'),
(5, '3BWCL1G04Q5V8', '300', '600', NULL, '1', '0', NULL, '2019-07-13 13:56:08', '2019-07-13 14:01:48');
...
(3, '2019_06_12_182401_create_homes_table', 1),
(4, '2019_06_12_182411_create_abouts_table', 1),
(5, '2019_06_12_182425_create_contacts_table', 1),
(6, '2019_06_12_182749_create_articles_table', 1),
(7, '2019_06_12_182759_create_dog_farms_table', 1),
(8, '2019_06_12_182809_create_dog_breeds_table', 1),
(9, '2019_06_12_182820_create_dogs_table', 1),
(10, '2019_06_12_182835_create_microchips_table', 1),
(11, '2019_06_18_071556_create_install_microchips_table', 1),
(12, '2019_06_18_074937_create_orders_table', 1),
(13, '2019_06_20_164618_create_sells_table', 1),
(14, '2019_06_21_032833_create_transports_table', 1),
(15, '2019_06_22_095519_create_request_change_owners_table', 1);
...
CREATE TABLE `orders` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `order_dog` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_dog_buy_price` decimal(8,0) DEFAULT NULL,
  `order_dog_sell_price` decimal(8,0) DEFAULT NULL,
  `order_dog_discount_price` decimal(8,0) DEFAULT NULL,
  `order_microchip` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_microchip_buy_price` decimal(8,0) DEFAULT NULL,
  `order_microchip_sell_price` decimal(8,0) DEFAULT NULL,
  `order_microchip_discount_price` decimal(8,0) DEFAULT NULL,
  `order_cus_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_cus_tel_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_cus_house_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_cus_village_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_cus_lane` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_cus_road` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_cus_province` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_cus_amphures` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_cus_districts` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_cus_post_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_deliveryman` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_send_time` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_receive_time` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_transport` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_transport_price` decimal(8,0) NOT NULL,
  `order_tracking_no` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order_type` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_status` char(1) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_id` char(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `microchip_id` char(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `orders` (`id`, `order_dog`, `order_dog_buy_price`, `order_dog_sell_price`, `order_dog_discount_price`, `order_microchip`, `order_microchip_buy_price`, `order_microchip_sell_price`, `order_microchip_discount_price`, `order_cus_name`, `order_cus_tel_no`, `order_cus_house_no`, `order_cus_village_no`, `order_cus_lane`, `order_cus_road`, `order_cus_province`, `order_cus_amphures`, `order_cus_districts`, `order_cus_post_no`, `order_deliveryman`, `order_send_time`, `order_receive_time`, `order_transport`, `order_transport_price`, `order_tracking_no`, `order_type`, `order_status`, `dog_id`, `microchip_id`, `created_at`, `updated_at`) VALUES
(1, 'สุนัข 1 - ปอมเมอเรเนียน สีดำ ตัวเมีย ฟาร์ม TinyDog', '5000', '7500', '300', NULL, NULL, NULL, NULL, 'Customer 1', '0982653256', '12', '-', '8', 'road1', 'กระบี่', 'เขาพนม', 'สินปุน', '50120', 'Deliveryman 1', '6.30', '16.30', 'การบินไทย', '300', 'R800356622222', '0', '3', '1', NULL, '2019-07-13 14:00:13', '2019-07-13 14:08:36'),
(2, NULL, NULL, NULL, NULL, 'ไมโครชิพ 5 - หมายเลข 3BWCL1G04Q5V8', '300', '600', NULL, 'Customer 1', '0956326523', '1/2', '5', '1', 'road2', 'ชัยนาท', 'หนองมะโมง', 'วังตะเคียน', '50233', 'Deliveryman 1', '8.30', '23.00', 'การบินไทย', '300', NULL, '1', '0', NULL, '5', '2019-07-13 14:01:48', '2019-07-13 14:01:48'),
(3, 'สุนัข 8 - ปอมเมอเรเนียน สีขาวลายน้ำตาล ตัวเมีย ฟาร์ม TinyDog', '6000', '9000', '500', 'ไมโครชิพ 2 - หมายเลข 5U5QZP5B8PO3E', '400', '800', '20', 'Customer 2', '0653262225', '5/2', '-', '2', 'road2', 'เพชรบุรี', 'ชะอำ', 'นายาง', '12345', 'Deliveryman 1', '6.30', '11.00', 'การบินไทย', '300', 'IMS1500266666', '2', '3', '8', '2', '2019-07-13 14:04:25', '2019-07-13 14:08:26'),
(4, 'สุนัข 7 - ปอมเมอเรเนียน สีดำอ่อน ตัวเมีย ฟาร์ม CutePet', '6000', '9000', '600', NULL, NULL, NULL, NULL, 'Customer 2', '0235662555', '11', '2', '1', 'road3', 'นครราชสีมา', 'ชุมพวง', 'ไพล', '12356', 'Deliveryman 1', '16.30', '23.00', 'นกแอร์', '400', NULL, '0', '0', '7', NULL, '2019-07-13 14:05:43', '2019-07-13 14:05:43'),
(5, NULL, NULL, NULL, NULL, 'ไมโครชิพ 1 - หมายเลข 658HI4DH1ZLRU', '500', '1000', NULL, 'Customer 3', '0256333333', '2', '2', '2', 'road2', 'ฉะเชิงเทรา', 'สนามชัยเขต', '*ท่าตะเกียบ', '53200', 'Deliveryman 1', '12.30', '21.30', 'การบินไทย', '300', 'OK00000000000', '1', '3', NULL, '1', '2019-07-13 14:06:24', '2019-07-13 14:08:39'),
(6, 'สุนัข 5 - ปอมเมอเรเนียน สีขาว ตัวผู้ ฟาร์ม TinyDog', '5500', '8000', NULL, 'ไมโครชิพ 3 - หมายเลข 96AGXC8OJ9LYW', '300', '600', NULL, 'Customer 2', '0690000000', '1', '2', '3', 'road1', 'นครปฐม', 'สามพราน', 'ยายชา', '12111', 'Deliveryman 2', '8.30', '20.30', 'การบินไทย', '300', 'SE23500D00000', '2', '3', '5', '3', '2019-07-13 14:21:04', '2019-07-13 14:21:42'),
(7, 'สุนัข 2 - ปอมเมอเรเนียน สีขาว ตัวเมีย ฟาร์ม TinyDog', '4500', '7000', '2600', NULL, NULL, NULL, NULL, 'test', '0849191500', 'f,sdofm', 'dfos', '0484949', 'sdsfsdf', 'นครปฐม', 'สามพราน', 'คลองจินดา', '50180', 'Deliveryman 2', '6.30', '17.00', 'รถยนต์', '150', '1233333333333', '0', '3', '2', NULL, '2019-07-14 01:18:29', '2019-07-14 01:22:43'),
(8, NULL, NULL, NULL, NULL, 'ไมโครชิพ 4 - หมายเลข K9FV1YEP0VVJG', '400', '800', NULL, 'นิศา แก้วมะคำ', '0849191500', '62/1', '13', '1', '-', 'ลำพูน', 'แม่ทา', 'ทาสบเส้า', '51140', 'Deliveryman 1', '12.30', '17.00', 'รถยนต์', '150', '1111111111111', '1', '3', NULL, '4', '2019-07-15 04:23:24', '2019-07-15 04:30:59');
...
--
-- Table structure for table `request_change_owners`
--

CREATE TABLE `request_change_owners` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `install_microchip_breed` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_color` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_sex` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_owner_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_owner_tel_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_owner_house_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_owner_village_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_owner_lane` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_owner_road` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_owner_province` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_owner_amphures` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_owner_districts` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `old_owner_post_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_tel_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_house_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_village_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_lane` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_road` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_province` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_amphures` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_districts` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_post_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `request_change_owner_status` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `install_microchip_id` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `microchip_id` char(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `dog_id` char(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `request_change_owners`
--

INSERT INTO `request_change_owners` (`id`, `install_microchip_breed`, `install_microchip_color`, `install_microchip_sex`, `install_microchip_no`, `old_owner_name`, `old_owner_tel_no`, `old_owner_house_no`, `old_owner_village_no`, `old_owner_lane`, `old_owner_road`, `old_owner_province`, `old_owner_amphures`, `old_owner_districts`, `old_owner_post_no`, `request_change_owner_name`, `request_change_owner_tel_no`, `request_change_owner_house_no`, `request_change_owner_village_no`, `request_change_owner_lane`, `request_change_owner_road`, `request_change_owner_province`, `request_change_owner_amphures`, `request_change_owner_districts`, `request_change_owner_post_no`, `request_change_owner_status`, `install_microchip_id`, `microchip_id`, `dog_id`, `created_at`, `updated_at`) VALUES
(1, 'ปอมเมอเรเนียน', 'สีขาว', 'ตัวผู้', '96AGXC8OJ9LYW', 'Customer 2', '0690000000', '1', '2', '3', 'road1', 'นครปฐม', 'สามพราน', 'ยายชา', '12111', 'Customer 3', '0988563256', '123', '-', '5', 'road 5', 'ตาก', 'สามเงา', 'ยกกระบัตร', '50236', '1', '2', '3', '5', '2019-07-13 14:23:09', '2019-07-13 14:25:03'),
(2, 'ปอมเมอเรเนียน', 'สีขาว', 'ตัวผู้', '96AGXC8OJ9LYW', 'Customer 3', '0988563256', '123', '-', '5', 'road 5', 'ตาก', 'สามเงา', 'ยกกระบัตร', '50236', 'ชาณิศา แก้วมะคำ', '0849191500', '62/1', '13', '1', '-', 'ลำพูน', 'แม่ทา', 'ทาสบเส้า', '51140', '1', '2', '3', '5', '2019-07-15 04:12:25', '2019-07-15 04:14:59');
...
CREATE TABLE `sells` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `sell_dog` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sell_dog_buy_price` decimal(8,0) DEFAULT NULL,
  `sell_dog_sell_price` decimal(8,0) DEFAULT NULL,
  `sell_dog_discount_price` decimal(8,0) DEFAULT NULL,
  `sell_microchip` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sell_microchip_buy_price` decimal(8,0) DEFAULT NULL,
  `sell_microchip_sell_price` decimal(8,0) DEFAULT NULL,
  `sell_microchip_discount_price` decimal(8,0) DEFAULT NULL,
  `sell_cus_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sell_cus_tel_no` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `sell_cus_address` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `sell_transport_price` decimal(8,0) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `sells` (`id`, `sell_dog`, `sell_dog_buy_price`, `sell_dog_sell_price`, `sell_dog_discount_price`, `sell_microchip`, `sell_microchip_buy_price`, `sell_microchip_sell_price`, `sell_microchip_discount_price`, `sell_cus_name`, `sell_cus_tel_no`, `sell_cus_address`, `sell_transport_price`, `created_at`, `updated_at`) VALUES
(1, 'สุนัข 8 - ปอมเมอเรเนียน สีขาวลายน้ำตาล ตัวเมีย ฟาร์ม TinyDog', '6000', '9000', '500', 'ไมโครชิพ 2 - หมายเลข 5U5QZP5B8PO3E', '400', '800', '20', 'Customer 2', '0653262225', 'บ้านเลขที่ 5/2 หมู่ที่ - ซอย 2 ถนน road2 จังหวัด เพชรบุรี อำเภอ ชะอำ ตำบล นายาง หมายเลขไปรณีย์ 12345', '300', '2019-06-13 14:08:26', '2019-07-13 14:08:26'),
(2, 'สุนัข 1 - ปอมเมอเรเนียน สีดำ ตัวเมีย ฟาร์ม TinyDog', '5000', '7500', '300', NULL, NULL, NULL, NULL, 'Customer 1', '0982653256', 'บ้านเลขที่ 12 หมู่ที่ - ซอย 8 ถนน road1 จังหวัด กระบี่ อำเภอ เขาพนม ตำบล สินปุน หมายเลขไปรณีย์ 50120', '300', '2018-07-13 14:08:36', '2019-07-13 14:08:36'),
(3, NULL, NULL, NULL, NULL, 'ไมโครชิพ 1 - หมายเลข 658HI4DH1ZLRU', '500', '1000', NULL, 'Customer 3', '0256333333', 'บ้านเลขที่ 2 หมู่ที่ 2 ซอย 2 ถนน road2 จังหวัด ฉะเชิงเทรา อำเภอ สนามชัยเขต ตำบล *ท่าตะเกียบ หมายเลขไปรณีย์ 53200', '300', '2019-06-13 14:08:39', '2019-07-13 14:08:39'),
(4, 'สุนัข 5 - ปอมเมอเรเนียน สีขาว ตัวผู้ ฟาร์ม TinyDog', '5500', '8000', NULL, 'ไมโครชิพ 3 - หมายเลข 96AGXC8OJ9LYW', '300', '600', NULL, 'Customer 2', '0690000000', 'บ้านเลขที่ 1 หมู่ที่ 2 ซอย 3 ถนน road1 จังหวัด นครปฐม อำเภอ สามพราน ตำบล ยายชา หมายเลขไปรณีย์ 12111', '300', '2019-07-13 14:21:42', '2019-07-13 14:21:42'),
(5, 'สุนัข 2 - ปอมเมอเรเนียน สีขาว ตัวเมีย ฟาร์ม TinyDog', '4500', '7000', '2600', NULL, NULL, NULL, NULL, 'test', '0849191500', 'บ้านเลขที่ f,sdofm หมู่ที่ dfos ซอย 0484949 ถนน sdsfsdf จังหวัด นครปฐม อำเภอ สามพราน ตำบล คลองจินดา หมายเลขไปรณีย์ 50180', '150', '2019-07-14 01:22:43', '2019-07-14 01:22:43'),
(6, NULL, NULL, NULL, NULL, 'ไมโครชิพ 4 - หมายเลข K9FV1YEP0VVJG', '400', '800', NULL, 'นิศา แก้วมะคำ', '0849191500', 'บ้านเลขที่ 62/1 หมู่ที่ 13 ซอย 1 ถนน - จังหวัด ลำพูน อำเภอ แม่ทา ตำบล ทาสบเส้า หมายเลขไปรณีย์ 51140', '150', '2019-07-15 04:30:59', '2019-07-15 04:30:59');
...
CREATE TABLE `transports` (
  ...
  `transport_price` decimal(8,0) NOT NULL,
  `transport_count` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `transports` (`id`, `transport_name`, `transport_price`, `transport_count`, `created_at`, `updated_at`) VALUES
(1, 'รถยนต์', '150', 2, '2019-07-13 13:56:08', '2019-07-15 04:23:24'),
(2, 'การบินไทย', '300', 5, '2019-07-13 13:56:08', '2019-07-13 14:21:04'),
(3, 'นกแอร์', '400', 1, '2019-07-13 13:56:08', '2019-07-13 14:05:43');
...
(1, 'Admin', 'admin@mail.com', NULL, '$2y$10$bC.24GYPNiubpay2O3ie.ei0kAl2/xc2KAMuAT7.pRvWcz9bEub4a', NULL, 'Admin', '2019-07-13 13:56:08', '2019-07-13 13:56:08'),
(2, 'Deliveryman 1', 'deliveryman1@mail.com', NULL, '$2y$10$H81VX1n/Ln.iaU0tlGhqkezD3ybwoQy8J1L6fgtGZyE/PUGCC75rW', NULL, 'Deliveryman', '2019-07-13 13:56:08', '2019-07-13 13:56:08'),
(3, 'Deliveryman 2', 'deliveryman2@mail.com', NULL, '$2y$10$m27QKpBgqgcc3lqgPaOv/.rpSirAA45fNztjEpZCmv1QMz.sFveX2', NULL, 'Deliveryman', '2019-07-13 13:56:08', '2019-07-13 13:56:08'),
(5, 'ชาณิศา', 'ni@gmail.com', NULL, '$2y$10$slv1ugjtouLRegGr4Lqz2OFlCAbmoBeJzauvLvgUdSNzWLAmRM2yO', NULL, 'Member', '2019-07-15 04:42:16', '2019-07-15 04:42:16');
...
--
-- Indexes for table `dog_farms`
--
ALTER TABLE `dog_farms`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `install_microchips`
--
ALTER TABLE `install_microchips`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `microchips`
--
ALTER TABLE `microchips`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `request_change_owners`
--
ALTER TABLE `request_change_owners`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `dog_farms`
--
ALTER TABLE `dog_farms`
...
--
-- AUTO_INCREMENT for table `install_microchips`
--
ALTER TABLE `install_microchips`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `microchips`
--
ALTER TABLE `microchips`
...
--
-- AUTO_INCREMENT for table `request_change_owners`
--
ALTER TABLE `request_change_owners`
